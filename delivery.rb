...
class Delivery
    ...
    def shot_selection
        ...
        input = prompt.select("Select your shot", %w(Defensive Balanced Attacking Very-Attacking Scorecard))
        if input == "Defensive"
            @shot_input = 1
            ...
            @shot_input = 4
        elsif input == "Scorecard"
            Scorecard.summary
            shot_selection
        else
            puts "please select a shot selection option"
        end
    end
